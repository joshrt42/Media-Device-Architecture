...
# 31 "main.c" 2
# 1 "text.h" 1
void drawChar(int row, int col, char ch, unsigned char colorIndex);
void drawString(int row, int col, char *str, unsigned char colorIndex);
# 32 "main.c" 2
# 1 "game.h" 1
# 12 "game.h"
typedef struct {
...
# 1 "pause1.h" 1
# 20 "pause1.h"
extern const unsigned short pause1Bitmap[19200];
# 37 "main.c" 2
# 1 "pause2.h" 1
# 20 "pause2.h"
extern const unsigned short pause2Bitmap[19200];
# 38 "main.c" 2
# 1 "lose.h" 1
# 20 "lose.h"
...
# 1 "gamebg.h" 1
# 20 "gamebg.h"
extern const unsigned short gamebgBitmap[19200];
# 41 "main.c" 2
# 1 "refresher.h" 1
# 20 "refresher.h"
extern const unsigned short refresherBitmap[13440];
# 42 "main.c" 2
# 1 "blue.h" 1
# 20 "blue.h"
extern const unsigned short blueBitmap[48];
# 43 "main.c" 2
...
void gotoGame() {
 ...
 drawFullScreenImage(gamebgBitmap);
    drawString(145, 5, "Virii left:\0", ((31) | (31)<<5 | (31)<<10));
 flipPage();
 drawFullScreenImage(gamebgBitmap);
    drawString(145, 5, "Virii left:\0", ((31) | (31)<<5 | (31)<<10));
...
void game() {
 ...
 drawImage(145, 73, 8, 12, blueBitmap);
    drawString(145, 72, buffer, ((31) | (31)<<5 | (31)<<10));
