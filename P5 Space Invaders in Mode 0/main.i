...
extern PLAYERBULLET playerBullets[5];
extern ENEMYBULLET enemyBullets[5];
extern ENEMY enemies[30];
extern BARRIER barriers[4];
...
# 1 "start0.h" 1
# 22 "start0.h"
extern const unsigned short start0Tiles[2496];


extern const unsigned short start0Map[1024];


extern const unsigned short start0Pal[256];
# 43 "main.c" 2
# 1 "lines.h" 1
# 21 "lines.h"
extern const unsigned short linesTiles[32];


extern const unsigned short linesMap[1024];
# 44 "main.c" 2
# 1 "pause.h" 1
# 22 "pause.h"
...
void initialize() {
 ...
 DMANow(3, start0Tiles, &((charblock *)0x6000000)[0], 4992/2);
 DMANow(3, start0Map, &((screenblock *)0x6000000)[28], 2048/2);

 (*(volatile unsigned short*)0x400000A) = (0<<14) | ((1)<<2) | ((24)<<8);
 DMANow(3, linesTiles, &((charblock *)0x6000000)[1], 64/2);
 DMANow(3, linesMap, &((screenblock *)0x6000000)[24], 2048/2);
...
void gotoGame() {
 ...
 (*(volatile unsigned short *)0x04000010) = hOff/3;
 ...
 DMANow(3, gameBGMap, &((screenblock *)0x6000000)[28], 8192/2);

 DMANow(3, hudTiles, &((charblock *)0x6000000)[1], 544/2);
 DMANow(3, hudMap, &((screenblock *)0x6000000)[24], 2048/2);
...
void game() {
 ...
 (*(volatile unsigned short *)0x04000012) = vOff;
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<4))))
     ...
     hOff--;
 (*(volatile unsigned short *)0x04000010) = hOff/5;
...
void gotoPause() {
 ...
 DMANow(3, pauseTiles, &((charblock *)0x6000000)[0], 3648/2);
...
void gotoWin() {
 ...
 DMANow(3, winTiles, &((charblock *)0x6000000)[0], 3360/2);
...
void gotoLose() {
 ...
 DMANow(3, loseTiles, &((charblock *)0x6000000)[0], 3904/2);
