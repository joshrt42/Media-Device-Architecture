...
void update() {
 ...
 if ((~(*(volatile unsigned short *)0x04000130) & ((1<<6))) && bRow > 0) {
  bRow -= bRDel;
 }
 if ((~(*(volatile unsigned short *)0x04000130) & ((1<<7))) && bRow < 160 - bHeight) {
  bRow += bRDel;
 }
 if ((~(*(volatile unsigned short *)0x04000130) & ((1<<5))) && bCol > 0) {
  bCol -= bCDel;
 }
 if ((~(*(volatile unsigned short *)0x04000130) & ((1<<4))) && bCol < 240 - bWidth) {
  bCol += bCDel;
 }
 ...
 if (collision(gRow, gCol, gHeight, gWidth,
